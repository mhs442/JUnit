...
public class RepeatedTestsTest {
    ...
    @RepeatedTest(value = 100, name = "{displayName} - repetition {currentRepetition}/{totalRepetitions}")
    @DisplayName("Test add operation")
    void addNumber(TestReporter testReporter, RepetitionInfo repetitionInfo){
        Calculator calculator = new Calculator();

        testReporter.publishEntry(String.valueOf(repetitionInfo.getCurrentRepetition()));
        assertEquals(2, calculator.add(1, 1), "1 + 1 should equals 2");
    }
